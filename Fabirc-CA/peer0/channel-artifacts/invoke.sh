...
peer chaincode invoke -o orderer0.example.com:7050 --cafile $FABRIC_PATH/crypto/ordererOrganizations/example.com/orderers/orderer0.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C ch1 -n testnetCC -c '{"Args":["invoke","a","b","50"]}'
